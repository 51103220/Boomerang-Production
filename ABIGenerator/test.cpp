	...
	for (PBB bb = cfg->getFirstBB(it); bb; bb = cfg->getNextBB(it)) {
		if (bb->getType() == CALL) {
			...
			switch (prog->getFrontEndId()){
				...
				bool param16 = false;
				bool ispara1 = false;
				bool addparam1 = false;	for (stit = stmts.begin(); stit != stmts.end(); ++stit) {
					Statement* s = *stit;
					ispara1=false;
					if(!s->isAssignment())
						continue;
				...
				case PLAT_PENTIUM:{
				bool ispara2 = false;
				bool addparam2 = false;	for (stit = stmts.begin(); stit != stmts.end(); ++stit) {
					Statement* s = *stit;
					ispara2=false;
					if(!s->isAssignment())
						continue;
				...
				case PLAT_PARISC:{
				bool ispara3 = false;
				bool addparam3 = false;	for (stit = stmts.begin(); stit != stmts.end(); ++stit) {
					Statement* s = *stit;
					ispara3=false;
					if(!s->isAssignment())
						continue;
				...
				case PLAT_M68K:{
				bool ispara4 = false;
				bool addparam4 = false;	for (stit = stmts.begin(); stit != stmts.end(); ++stit) {
					Statement* s = *stit;
					ispara4=false;
					if(!s->isAssignment())
						continue;
				...
				case PLAT_PPC:{
				bool ispara5 = false;
				bool addparam5 = false;	for (stit = stmts.begin(); stit != stmts.end(); ++stit) {
					Statement* s = *stit;
					ispara5=false;
					if(!s->isAssignment())
						continue;
				...
				case PLAT_MIPS:{
				bool ispara6 = false;
				bool addparam6 = false;	for (stit = stmts.begin(); stit != stmts.end(); ++stit) {
					Statement* s = *stit;
					ispara6=false;
					if(!s->isAssignment())
						continue;
				...
				case PLAT_ST20:{
				bool ispara7 = false;
				bool addparam7 = false;	for (stit = stmts.begin(); stit != stmts.end(); ++stit) {
					Statement* s = *stit;
					ispara7=false;
					if(!s->isAssignment())
						continue;
				...
				case PLAT_GENERIC:{
				bool ispara8 = false;
				bool addparam8 = false;	for (stit = stmts.begin(); stit != stmts.end(); ++stit) {
					Statement* s = *stit;
					ispara8=false;
					if(!s->isAssignment())
						continue;
